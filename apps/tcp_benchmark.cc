...
void main_loop(const bool reorder) {
    ...
    auto loop = [&] {
        ...
        // cout << "**********************************************************************" << "\n";
        // cout << " XActive: " << x.active() << " YActive: " << y.active() << "\n";
        // cout << " XBytesInFlight: " << x.bytes_in_flight() << " YBytesInFlight: " << y.bytes_in_flight() << "\n";
        // cout << " XStatus: " << x.getState() << " YStatus: " << y.getState() << "\n";
        // cout << " XisFINSent: " << x.isFINSent() << " YisFINSent: " << y.isFINSent() << "\n";
        // cout << " XInbound_Stream Ended: " << x.inbound_stream().input_ended() << "\n";
        // cout << "**********************************************************************" << "\n";
